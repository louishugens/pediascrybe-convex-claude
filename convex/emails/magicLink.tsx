          ...
          <Container className="bg-[#ffffff] max-w-[600px] mx-auto px-[32px] py-[40px] rounded-[16px]">
            ...
            <div className="text-left">
              ...
              <Text className="text-[#64748b] text-[14px] leading-[20px] m-0 mt-[40px] pt-[24px]">
                <strong>Security Note:</strong> This magic link will expire in 15 minutes for your protection and can only be used once.
              </Text>
...
MagicLinkEmail.PreviewProps = {
  url: "https://www.pediascrybe.com/auth/magic-link?token=abc123xyz789",
  userName: "Dr. Sarah",
};
