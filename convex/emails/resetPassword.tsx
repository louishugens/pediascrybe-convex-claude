    ...
    <Html lang="en" dir="ltr">
      <Tailwind>
        ...
        <Body className="bg-[#f0f7ff] font-sans py-[40px] m-0">
          <Preview>Reset your Pediascrybe password and get back to your patients</Preview>
          <Container className="bg-[#ffffff] max-w-[600px] mx-auto px-[32px] py-[40px] rounded-[16px]">
            ...
            <div className="text-left">
              ...
              <Text className="text-[#1e3a5f] text-[16px] leading-[24px] m-0 mb-[32px]">
                We received a request to reset your password for your Pediascrybe account. 
                Don&apos;t worry &ndash; it happens to the best of us! Your pediatric documentation 
                platform is just one click away.
              </Text>
              
              <Text className="text-[#1e3a5f] text-[16px] leading-[24px] m-0 mb-[32px]">
                To create a new password and regain access to your clinical documentation 
                tools, simply click the button below:
              </Text>
              ...
              <Text className="text-[#1e3a5f] text-[16px] leading-[24px] m-0 mb-[24px]">
                Once you&apos;ve reset your password, you&apos;ll be back to:
              </Text>
              ...
              <Text className="text-[#1e3a5f] text-[16px] leading-[24px] m-0 mb-[8px] pl-[16px]">
                • Your saved templates and patient documentation
              </Text>
              <Text className="text-[#1e3a5f] text-[16px] leading-[24px] m-0 mb-[32px] pl-[16px]">
                • Streamlined pediatric workflows
              </Text>
              
              <Text className="text-[#64748b] text-[14px] leading-[20px] m-0 mt-[40px] pt-[24px] border-t border-solid border-[#e2e8f0]">
              ...
              <Text className="text-[#1e3a5f] text-[16px] leading-[24px] m-0 mt-[24px] font-medium">
                Ready to get back to caring for your patients? Let&apos;s get you signed in!
              </Text>
            </div>
...
ResetPasswordEmail.PreviewProps = {
  url: "https://www.pediascrybe.com/reset-password?token=abc123xyz",
  userName: "Dr. Carlos",
};
