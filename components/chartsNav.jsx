...
const ChartsNav = ({ patientId, }) => {
  ...
  return (
    ...
    {/* <Link href={`/user/patients/${patientId}/charts/hfa`} className={pathname === (`/user/patients/${patientId}/charts/hfa`) ? "mt-4 text-sm bg-blue-500 text-slate-100 rounded-full px-4 py-2 self-start" : "mt-4 text-sm text-blue-500 bg-slate-100 rounded-full px-4 py-2 self-start"}>Lenght for Age</Link> */}
