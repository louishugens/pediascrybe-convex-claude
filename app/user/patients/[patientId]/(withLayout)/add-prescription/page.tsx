...
const StandaloneAddPrescriptionPage = async (props: { params: Params }) => {
  return (
    <ViewTransition>
...
export default StandaloneAddPrescriptionPage
...
async function Container({ params }: { params: Params }) {
  ...
  return (
    <AddPrescriptions patient={patient} patientId={patientId} data-superjson />
  );
}
